    ...
    while x == 0:
        ...
        try:
            for data in login_user_data:
                if user_name == data[0]:
                    if passwd == data[2]:
                        print(f"Hello {user_name}, you have"
            ...
            print("Your username or password does not"
...
def signup(user_data):
    ...
    while True:
        ...
        while True:
            ...
            print("Please enter an email with the"
                  "format name@some_address.com")
            ...
            if re.fullmatch(regex, email_address):
                ...
                print("Please enter a valid email format with the"
                      "format name@some_address.com")
        while True:
            print("Your password must be 8 characters long,"
                  "must contain a capital letter(s),")
            print("small letter(s) and at least a number"
                  "and special characters")
            print("For example:XdsE83&! \n")
            new_passwd = input("Enter password:\n")

            # compiling regex
            reg_pass = r'^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)'
            '(?=.*[@$!%*#?& ])[A-Za-z\\d@$!#%*?&]{8,18}$'
        ...
        if conf_passwd == new_passwd:
            ...
            print(f'Your username {new_username}'
                  'and password has been stored successfully!!!\n')
